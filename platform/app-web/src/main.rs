use dioxus::prelude::*;
use protocol::{
    ClientDragon, ClientGameState, ClientSessionSnapshot, CoordinatorType, CreateWorkshopRequest,
    DragonAction, DragonEmotion, JoinWorkshopRequest, JudgeBundle, NoticeLevel, Phase, Player,
    ServerWsMessage, SessionCommand, SessionEnvelope, SessionNotice as ProtocolSessionNotice,
...
#[allow(dead_code)]
const SESSION_SNAPSHOT_STORAGE_KEY: &str = "dragon-switch/platform/session-snapshot";
...
mod tests {
    use super::*;
    use protocol::{create_default_session_settings, SessionMeta};
